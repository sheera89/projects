/* Sandeep Heera
 * lab_6.ino
 * This program corresponds to parts 1 and 2 of Lab 6. The purpose of this program is to
 * drive the autonomous robot forward until it encounters an obstacle in it's path
 * at a distance of 6 inches at which point the robot must reverse. It must then scan the field
 * to it's immediate left and immediate right and determine the least obstructed path and 
 * move in that direction. In addition to the above, the robot must detect a particular color
